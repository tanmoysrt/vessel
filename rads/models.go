...
type Backend struct {
	...
	DNSResolver  string              `gorm:"column:dns_resolver;index;" json:"dns_resolver,omitempty"` // e.g., "8.8.8.8:53"

	// Hosts as JSON string (e.g., '["10.0.0.1","10.0.0.2"]'
	Hosts StringList `gorm:"column:hosts;type:text;index;not null" json:"hosts"`
...
type HTTPRedirectRule struct {
	...
	// Redirect Target - User will need to provide at-least one of the following
